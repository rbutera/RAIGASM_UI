...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Warlords Leveling|r", "Warlords Enchanting 1-100", nil, "Alliance", nil, "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Enchanting]], nil, 700) and UnitLevel([[player]])>=90|", function()
return [[
...
N More Work Orders |ENC| |N|Continue creating work orders to collect (item:115504), these are required for Enchanting recipes. <br/><b>Each Work Order requires 5 (item:109693). <br/><br/>Tick this step.| |P|348 700|

N (item:119293) |ENC| |N|Craft with; <br/><b>3 (item:109693)| |P|348 605|
...
N (item:115504) |ENC| |N|Create (item:115504) daily. These are required for leveling and high level recipes. <br/><b>1 (item:111245). <br/><br/>Tick this step.| |P|348 700|

N Required Materials; |N|12500 (item:109693)| |P|348 625|
N 1-625 (item:111245) |ENC| |N|Craft (item:111245) with; <br/><b>20 (item:109693)| |P|348 625|
N Required Materials; |N|75 (item:115504)| |P|348 700|
N 625-700 (item:112093) |ENC| |N|Craft (item:112093) with; <br/><b>1 (item:113588)| |P|348 700|
