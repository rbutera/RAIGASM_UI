...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Warlords Leveling|r", "Warlords Alchemy 1-100", nil, "Horde", nil, "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Alchemy]], nil, 700) and UnitLevel([[player]])>=90|", function()
return [[
...
end, {description = [[This guide covers how to level up the Alchemy profession from 1-100]]})	
	end
