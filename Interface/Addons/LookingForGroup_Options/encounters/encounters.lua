...
LookingForGroup_Options.RegisterSimpleFilter("find",function(groupid,profile,mbnm)
	local rse = C_LFGList.GetSearchResultEncounterInfo(groupid)
...
LookingForGroup_Options.RegisterSimpleFilter("find",function(groupid) return C_LFGList.GetSearchResultEncounterInfo(groupid) and 1 or 0 end,function(profile) return profile.a.new end)
