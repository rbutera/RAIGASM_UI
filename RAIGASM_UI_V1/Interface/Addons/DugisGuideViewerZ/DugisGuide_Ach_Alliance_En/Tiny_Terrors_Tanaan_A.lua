local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Dailies_Alliance_En_Tiny_Terrors_Tanaan_A")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Battle Pets|r ", "Tiny Terrors in Tanaan", nil, "Alliance", nil, "A", "|SG|UnitLevel([[player]])|>=100|", function()
return [[
