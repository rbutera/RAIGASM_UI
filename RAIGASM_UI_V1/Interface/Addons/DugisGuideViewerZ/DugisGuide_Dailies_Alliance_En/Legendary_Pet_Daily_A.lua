local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Dailies_Alliance_En_Legendary_Pets_A")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Draenor|r", "Tanaan Legendary Pets (Daily)", nil, "Alliance", nil, "D", "|SG|UnitLevel([[player]])|>=100|", function()
return [[
