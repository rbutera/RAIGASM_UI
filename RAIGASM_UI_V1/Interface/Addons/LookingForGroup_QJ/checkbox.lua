...
local function updateqjtitle(obj)
	...
	local name,color,relationship = SocialQueueUtil_GetRelationshipInfo(select(7,C_SocialQueue.GetGroupInfo(val)))
	obj:SetLabel(color..name..FONT_COLOR_CODE_CLOSE)
	wipe(concat_tb)
